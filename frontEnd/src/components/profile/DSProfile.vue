  ...
  <div>
    <div class="w-full p-4 bg-white bg-center bg-cover rounded-2xl shadow-md">
      ...
      <p class="text-text">
        ...
        ipsum aspernatur libero error, in nihil iusto veritatis neque atque numquam optio, placeat
        adipisci mollitia dicta voluptatem molestias.
      </p>
    </div>
    ...
    <div class="w-full p-4 bg-white bg-center bg-cover rounded-2xl shadow-md">
      ...
      <div class="flex mt-3 -mx-2">
        <a
          href="#"
          class="mx-2 text-primary transition-colors duration-300 hover:text-second"
          aria-label="Reddit"
        >
          <svg
